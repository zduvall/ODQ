    ...
    <div className='site__page'>
      <div className='site__sub-section terms-of-use'>
        ...
        <p>
          ...
          eDOT has no control. There may also be thir-party links over whom
          eDOT has no control that access this website. eDOT makes no
          warranties, guaranties, or representations of any kind as to the
          completeness, accuracy, or recentness of any and all information found
          in such third-party websites, including any third-party mobile app and
          social media platforms. No recommendation or endorsement by eDOT is
          implied by inclusion of any third-party links on this website. Links
          from another webiste to this website do not imply any relationship
          between eDOT and any third party. Your use of any third-party
          websites is governed by such third party's terms and policies
          (including its privacy policy) and is at your own risk.
        </p>
        ...
        <p>
          ...
          hereof. eDOT reserves the right to alter or delete materials from
          this Web site at any time at its discretion.
        </p>
      </div>
